...
describe("Compromised challenge", function () {
  ...
  it("Execution", async function () {
    ...
    // Private keys of the accounts that can control the price of the nftToken
    const keys = [
      "0xc678ef1aa456da65c6fc5861d44892cdfac0c6c8c2560bf0c9fbcdae2f4735a9",
      "0x208242c40acdfa9ed889e685c23547acbed9befc60371e9875fbcd736340bb48",
    ];
    const wallet1 = new ethers.Wallet(keys[0], ethers.provider);
    const wallet2 = new ethers.Wallet(keys[1], ethers.provider);

    // Set the price of the nftToken to 0 before buying
